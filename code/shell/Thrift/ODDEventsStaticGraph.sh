...
SOOTCP=".:$subjectloc/java/bin:$subjectloc/0110/lib/java/build:$ROOT/DistODD.jar"
...
java -Xmx400g -ea -cp ${MAINCP} ODD.ODDEventsStaticGraph \
	-w -cp ${SOOTCP} \
...
cp $OUTDIR/staticVtg.dat $subjectloc/staticVtg.dat
