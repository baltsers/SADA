/**
 * File: src/ODD/ODDEventsStaticGraph.java
 * -------------------------------------------------------------------------------------------
 * Date			Author      Changes
 * -------------------------------------------------------------------------------------------
...
public class ODDEventsStaticGraph extends EAInst {
	...
	public static void main(String args[]){
		...
		ODDEventsStaticGraph osg = new ODDEventsStaticGraph();
	...
	@Override public void run() {
		...
		//ODDUtil.createOrCopyFile("staticConfiguration.txt","11",staticConFigurationFileName);
	     //if (opts.debugOut()) 
	     {
	    	 System.out.println("Running DistODD Event Static Graph");
	     }
...
//			vtg.setHeFlowSens(flowS);	
			ArrayList coveredMethods=ODDUtil.getArrayList(ODDUtil.getNewestFile ("", "DistODD_Queue"));
			//System.out.println("coveredMethods=" + coveredMethods);
			if (coveredMethods.size()>1)
			{
				vtg.buildGraph(false,flowS, contextS, coveredMethods);
			}
			else
...
//				System.out.println(vtg2);
		...
		{
			String fileName=ODDUtil.getstaticVtgFileName("DistODDEventsFile");
			System.out.println("fileName="+fileName);
			String fn = dua.util.Util.getCreateBaseOutPath() + fileName;
